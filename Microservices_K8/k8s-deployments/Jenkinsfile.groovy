        ...
        stage('Create EKS Cluster') {
            steps {
                script {
                    ...
                    sh "aws cloudformation create-stack --stack-name eks-cluster-stack --template-body file://Microservices_K8/k8s-deployments/solo-eks.yml --parameters ParameterKey=ClusterName,ParameterValue=${EKS_CLUSTER_NAME} --region ${AWS_DEFAULT_REGION} --capabilities CAPABILITY_NAMED_IAM"
